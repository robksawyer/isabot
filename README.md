...
![ISABOT LOGO](http://s7.postimg.org/l0lslshwr/isabot.jpg)
...
This README is intended to help get you started. But there is a better introduction to Hubot over at <http://thejacklawson.com/how-to-hubot/#/9>.
...
Run the command below in the #general channel of [Slack](http://slack.com) to check it out. Note: The name 'isabot' below matches whatever variable is set via the variable HUBOT\_SLACK\_BOTNAME.
...
This is your team's Slack subdomain. For example, if your team is `https://thatminnow.slack.com/`, you would enter `myteam` here.
