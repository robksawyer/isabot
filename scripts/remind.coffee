...
#
# Commands:
#   hubot remind me in <time> to <action> - Set a reminder in <time> to do an <action> <time> is in the format 1 day, 2 hours, 5 minutes. (Time segments are optional, as are commas)
#
# Author:
#   unknown
#
