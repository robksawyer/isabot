...
#
# Configuration:
#   Sign up for an account at http://www.articlemanager.us.
#   HUBOT_SPINNER_SECRET_KEY
#   HUBOT_SPINNER_ACCESS_KEY
#
# Commands:
#   hubot spin me <query> - Returns a spun version of the input.
#   hubot spun me <query> - Returns a spintax version of the input using articlemanager.us spinner API.
#   hubot spun and spin me <query> - Returns a spun version of the input using spun me command first.
#   hubot spin the last spun - Returns a spun version of the user centric input generated by the last spun me call.
# 
# Example:
#   hubot spin me This is {my nested {spintax|spuntext} formatted string|your nested {spintax|spuntext} formatted string} test.
#   
# Author:
#   unknown
#
